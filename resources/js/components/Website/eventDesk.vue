    ...
    <div>
        <section class="event-desk">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mt-3" v-for="newsEvents in newsEventsData">
                        <div class="recent-events">
                            <div class="image-section">
                                <img class="img-fluid" :src="newsEvents.photo" alt="Recent News and Event Image">
                            </div>
